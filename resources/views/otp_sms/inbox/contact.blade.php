            ...
            <div class="select-group-chat">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{route('otp.index',$usertNumbers->number->mobile)}}">
       ...
       <!-- /Left Chat Title -->
        ...
        <div class="sidebar-body chat-body" id="chatsidebar">
            ...
            <ul class="user-list space-chat">
                <li class="user-list-item chat-user-list onloadpage" data-url="{{route('otp.lists',$twillio_id)}}">
                </li>
            </ul>
