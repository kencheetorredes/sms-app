    ...
    <tr>
        ...
        <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
            ...
            <tr>
                ...
                <p style="font-family: Helvetica, sans-serif; font-size: 18px; font-weight: 600; margin: 0; margin-bottom: 20px; border-top: 1px solid #f7f7ff; padding-top: 30px;">Welcome, {{$info['name']}}!</p>
                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">We're thrilled to have you on board.</p>   
                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">For reference, here's your temporary login credentials:</p>
                <p style="background-color: #e3e0e0; color: #000; padding: 30px; font-size: 18px;">
                    <span><strong>Email:</strong> {{$info['email']}}</span><br />
                    <span><strong>Password:</strong> {{$info['password']}}</span>
                </p>
                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">We strongly advice to reset your password immediately once logged in.</p>
                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 25px;">To reset your password, view your profile, or manage the content of the website, click the button below to log in to your account.</p>
