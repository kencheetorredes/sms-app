                ...
                <div>
                    <div class="chat-header">
                        <div class="user-details">
                            ...
                            <div class="mt-1">
                                <h5 class="pb-1 pt-1">Semaphore Sender Name<br>
                                <small class="text-muted">Manage your Semaphore sender names</small>
                                </h5>
                            </div>
                        </div>
                          <div class="chat-options ">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="New">
                                    <a href="javascript:void(0)" class="btn btn-outline-light  pop-up" data-template="{{route('setting.semaphore_sender_name.create')}}">
                    ...
                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 596px;">
                        ...
                        <div class="messages">
                            <table class="table" id="list_table" data-sort-name="sender_name" data-ispopup="true" data-sort-order="asc" data-explode="" data-search="true"  data-target="{{route('setting.semaphore_sender_name.create')}}" data-row="id" data-toolbar="#toolbar"
                                data-toggle="table" data-url="{{route('setting.semaphore_sender_name.lists')}}"  data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200,500,1000]"  >
